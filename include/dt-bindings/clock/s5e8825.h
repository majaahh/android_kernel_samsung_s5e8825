...
#define MOUT_CLKCMU_G3D_BUS_USER						(CLK_G3D_BASE + 0)
#define DOUT_DIV_CLK_G3D_BUSD							(CLK_G3D_BASE + 1)
#define DOUT_DIV_CLK_G3D_BUSP							(CLK_G3D_BASE + 2)
#define GATE_D_TZPC_G3D_QCH							(CLK_G3D_BASE + 3)
#define GATE_G3D_CMU_G3D_QCH							(CLK_G3D_BASE + 4)
#define GATE_GPU_QCH							(CLK_G3D_BASE + 5)
#define GATE_HTU_G3D_QCH_CLK							(CLK_G3D_BASE + 6)
#define GATE_HTU_G3D_QCH_PCLK							(CLK_G3D_BASE + 7)
#define GATE_LHM_AXI_P_INT_G3D_QCH							(CLK_G3D_BASE + 8)
#define GATE_LHS_AXI_P_INT_G3D_QCH							(CLK_G3D_BASE + 9)
#define GATE_LH_AXI_SI_D_G3D_QCH							(CLK_G3D_BASE + 10)
#define GATE_PPMU_D_G3D_QCH							(CLK_G3D_BASE + 11)
#define GATE_SLH_AXI_MI_P_G3D_QCH							(CLK_G3D_BASE + 12)
#define GATE_SYSMMU_D_G3D_QCH							(CLK_G3D_BASE + 13)
#define GATE_SYSREG_G3D_QCH							(CLK_G3D_BASE + 14)
#define GATE_VGEN_LITE_G3D_QCH							(CLK_G3D_BASE + 15)
#define GATE_GNSS_CMU_GNSS_QCH							(CLK_G3D_BASE + 16)
